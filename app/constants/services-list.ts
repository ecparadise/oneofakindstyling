export const servicesList = [
  ...
  },
  {
    ...
    cost: "$15",
    description:
      "Choice of phone call, SMS text or a video chat in scheduled increments of 15 minutes",
    disclaimer:
  ...
  {
    name: "Initial Style Consultation",
    cost: "$15",
    description:
      "15 mins of scheduled virtual communication, eligible one time per customer via phone call, SMS text or video call",
    link: {
